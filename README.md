...
- [Angular 4.x Decorator - 1](https://segmentfault.com/a/1190000008626417)
  - 涉及装饰器定义和分类、TypeScript 类装饰器、属性装饰器、方法装饰器、参数装饰器等
- [Angular 4.x Decorator - 2](https://segmentfault.com/a/1190000008626579)
